...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/adir95/deb7x64/master/squid/squid.conf"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/adir95/deb7x64/master/conf/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by Adir95</pre>" > /home/vps/public_html/index.php
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/adir95/deb7x64/master/conf/vps.conf"
...
#wget "https://raw.githubusercontent.com/adir95/deb7x64/master/dropbear201674/dropbear-2016.74.tar.bz2"
...
# bannerssh
wget "https://raw.githubusercontent.com/adir95/deb7x64/master/menu/bannersshlink.sh"
...
# auto kill dropbear
#wget "https://raw.githubusercontent.com/adir95/deb7x64/master/menu/userlimit.sh"
#mv ./userlimit /usr/bin/userlimit.sh
#chmod +x /usr/bin/userlimit.sh
#echo " /etc/security/limits.conf" > /etc/security/limits.conf

# auto kill openssh
#wget "https://raw.githubusercontent.com/adir95/deb7x64/master/menu/userlimitssh.sh"
#mv ./userlimitssh.sh /usr/bin/userlimitssh.sh
#chmod +x /usr/bin/userlimitssh.sh

# cranjob
#sudo apt-get install cron
#wget https://raw.githubusercontent.com/adir95/deb7x64/master/clearcache/crontab
#mv crontab /etc/
#chmod 644 /etc/crontab

# tool 
cd
wget -O userlimit.sh "https://raw.githubusercontent.com/adir95/deb7x64/master/menu/userlimit.sh"
wget -O userexpired.sh "https://raw.githubusercontent.com/adir95/deb7x64/master/menu/userexpired.sh"
#wget -O autokill.sh "https://raw.githubusercontent.com/adir95/deb7x64/master/menu/autokill.sh"
wget -O userlimitssh.sh "https://raw.githubusercontent.com/adir95/deb7x64/master/menu/userlimitssh.sh"
...
# clear cache
wget -O clearcache.sh "https://raw.githubusercontent.com/adir95/deb7x64/master/clearcache/clearcache.sh"
#echo "@reboot root /root/clearcache.sh" > /etc/cron.d/clearcache
chmod 755 /root/clearcache.sh

# userlimit
#cd
#wget "https://raw.githubusercontent.com/adir95/deb7x64/master/conf/limits.conf"
...
wget -O speedtest.py "https://raw.githubusercontent.com/adir95/deb7x64/master/menu/speedtest.py"
...
# shc file
cd
wget https://raw.githubusercontent.com/adir95/deb7x64/master/shc-3.8.7.tgz
...
wget https://raw.githubusercontent.com/adir95/deb7x64/master/ram/fstab
mv ./fstab /etc/fstab
chmod 644 /etc/fstab
...
#clear
echo "========================================"  
echo "Service Autoscript VPS DEBIAN 7 x64 Adi95" 
echo "----------------------------------------" 
echo ""  | tee -a log-install.txt
echo "Webmin   : http://$myip:10000/"
echo "Squid3   : 8080" 
echo "OpenSSH  : 22, 143"
echo "Dropbear : 80, 443, 109"
